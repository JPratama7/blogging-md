...
type CommentRepository interface {
	...
	FindByID(c context.Context, id string) (model.Comment, error)
	Update(c context.Context, comment model.Comment) (model.Comment, error)
	Delete(c context.Context, id string) (model.Comment, error)
}
